...
tuner = kt.RandomSearch(build_enn_model, objective='val_loss', max_trials=100, executions_per_trial=2, directory="",
                        project_name="DLR_ArchitectureSearch100ENN")
print('searching done')
tuner.search(x_train, y_train, epochs=50, validation_data=(x_validation, y_validation), batch_size=32,
